          ...
          <div className="flex items-center justify-between mb-4">
            ...
            {lowStockItems.length > 0 && (
              <Badge variant="destructive" className="flex items-center space-x-1">
                ...
                <span className="hidden sm:inline">{lowStockItems.length} alertas</span>
      ...
      <div className="container mx-auto py-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
          <TabsList className="grid w-full grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 h-auto">
            ...
            <TabsTrigger value="products" className="text-xs sm:text-sm px-2 py-2">Produtos</TabsTrigger>
            <TabsTrigger value="movements" className="text-xs sm:text-sm px-2 py-2">
              <span className="lg:hidden">Mov.</span>
              <span className="hidden lg:inline">Movimentações</span>
            </TabsTrigger>
            <TabsTrigger value="categories" className="text-xs sm:text-sm px-2 py-2">
              <span className="sm:hidden">Cat.</span>
              <span className="hidden sm:inline">Categorias</span>
            </TabsTrigger>
            <TabsTrigger value="alerts" className="text-xs sm:text-sm px-2 py-2">Alertas</TabsTrigger>
            <TabsTrigger value="reports" className="text-xs sm:text-sm px-2 py-2">
              <span className="lg:hidden">Rel.</span>
